...
|---|---|---|---|---|
| `nvidia/nemotron-3-super-120b-a12b` | 262K | $0.3 | $0.9 | root, critic |
| `nvidia/Nemotron-3-Ultra-550b-a55b` | 1.0M | $1 | $3 | root, critic |
| `moonshotai/Kimi-K3` | 1.0M | $3 | $15 | root, critic |
| `moonshotai/Kimi-K2.6` | 262K | — | — | root, critic, subagent, judge |
| `Qwen/Qwen3.5-397B-A17B` | 262K | $0.6 | $4 | root, critic |
| `zai-org/GLM-5.3` | 1.0M | — | — | root, critic |
| `deepseek-ai/DeepSeek-V4-Pro` | 1.0M | $2 | $4 | root, critic |
| `deepseek-ai/DeepSeek-V4-Flash-0731` | 1.0M | $0.14 | $0.28 | subagent, judge |
| `Qwen/Qwen3-30B-A3B-Instruct-2507` | 262K | $0.1 | $0.3 | subagent, judge |
| `meta-llama/Llama-3.3-70B-Instruct` | 128K | — | — | subagent, judge |
| `nvidia/Nemotron-3_5-Lightning` | 1.0M | $0.06 | $0.24 | subagent, judge |
| `zai-org/GLM-5.3-Flash` | 1.0M | $0.15 | $0.5 | subagent, judge |

Named in the brief but absent from the catalog: `deepseek-ai/DeepSeek-V3.2`, `deepseek-ai/DeepSeek-R1-0528`, `meta-llama/Llama-4-*`.

## Root — code-as-action plan

Fenced Python that executes in the real `Workspace` sandbox and leaves a valid `SearchPlan` with 3-7 branches (docs/03 §3, §12).

| model | pass | median s | tok in/out | cost/call | detail |
|---|---|---|---|---|---|
| `nvidia/nemotron-3-super-120b-a12b` | 5/5 | 4.4 | 254/1303 | $0.00125 | 5 branches; 6 branches |
| `nvidia/Nemotron-3-Ultra-550b-a55b` | 5/5 | 4.8 | 254/1339 | $0.00427 | 5 branches; 7 branches |
| `moonshotai/Kimi-K3` | 5/5 | 22.3 | 309/1842 | $0.0286 | 6 branches |
| `moonshotai/Kimi-K2.6` | 5/5 | 31.2 | 232/3314 | — | 5 branches; 6 branches |
| `Qwen/Qwen3.5-397B-A17B` | 5/5 | 21.9 | 252/3223 | $0.0130 | 5 branches |
| `deepseek-ai/DeepSeek-V4-Pro` | 5/5 | 7.4 | 240/841 | $0.00384 | 6 branches; 7 branches |
| `zai-org/GLM-5.3` | 2/5 | 33.8 | 238/7575 | — | 6 branches; no fenced python block |

## Critic — fenced JSON

A parseable JSON object (docs/01 §4). `flagged c1` means the model caught the planted weak claim: a coverage assertion resting on a vendor blog.

| model | pass | median s | tok in/out | cost/call | detail |
|---|---|---|---|---|---|
| `nvidia/nemotron-3-super-120b-a12b` | 3/3 | 3.3 | 213/934 | $0.00090 | flagged c1 |
| `nvidia/Nemotron-3-Ultra-550b-a55b` | 3/3 | 3.1 | 213/837 | $0.00272 | flagged c1 |
| `moonshotai/Kimi-K3` | 3/3 | 91.5 | 266/2631 | $0.0403 | flagged c1 |
| `moonshotai/Kimi-K2.6` | 3/3 | 32.0 | 189/4688 | — | flagged c1 |
| `Qwen/Qwen3.5-397B-A17B` | 3/3 | 23.2 | 208/3408 | $0.0138 | flagged c1 |
| `deepseek-ai/DeepSeek-V4-Pro` | 3/3 | 2.5 | 190/137 | $0.00093 | flagged c1 |
| `zai-org/GLM-5.3` | 1/3 | 25.7 | 193/6290 | — | flagged c1; unparseable: ValueError |
...
| model | pass | median s | tok in/out | cost/call | detail |
|---|---|---|---|---|---|
| `moonshotai/Kimi-K2.6` | 5/5 | 2.3 | 1456/244 | — | tavily_search(include_domains,query,search_depth) |
| `deepseek-ai/DeepSeek-V4-Flash-0731` | 5/5 | 1.7 | 1833/209 | $0.00032 | tavily_search(query,search_depth) |
| `Qwen/Qwen3-30B-A3B-Instruct-2507` | 5/5 | 1.4 | 1721/53 | $0.00019 | tavily_search(include_domains,query,search_depth,topic) |
| `meta-llama/Llama-3.3-70B-Instruct` | 5/5 | 35.4 | 1872/96 | — | tavily_search(end_date,exclude_domains,include_domains) |
| `nvidia/Nemotron-3_5-Lightning` | 5/5 | 1.5 | 2017/258 | $0.00018 | tavily_search(include_domains,query,search_depth); tavily_search(inclu |
| `zai-org/GLM-5.3-Flash` | 5/5 | 2.5 | 1674/238 | $0.00037 | tavily_search(query,search_depth) |

## Judge / extractor — structured output

`with_structured_output(Verdict)` measured **natively**, without `models.structured()`'s repair ladder, which otherwise hides the difference.

| model | pass | median s | tok in/out | cost/call | detail |
|---|---|---|---|---|---|
| `deepseek-ai/DeepSeek-V4-Flash-0731` | 3/3 | 1.6 | 0/0 | $0.00000 | Verdict |
| `Qwen/Qwen3-30B-A3B-Instruct-2507` | 3/3 | 1.9 | 0/0 | $0.00000 | Verdict |
| `meta-llama/Llama-3.3-70B-Instruct` | 3/3 | 13.7 | 0/0 | — | Verdict |
| `nvidia/Nemotron-3_5-Lightning` | 3/3 | 2.8 | 0/0 | $0.00000 | Verdict |
| `zai-org/GLM-5.3-Flash` | 3/3 | 2.6 | 0/0 | $0.00000 | Verdict |
| `moonshotai/Kimi-K2.6` | 2/3 | 4.2 | 0/0 | — | Verdict; returned NoneType |
...
104 model calls. Measured spend on the 72 calls to models with a
published price: **$0.4359**. The remaining 32 calls went to models with no price row (Kimi-K2.6, GLM-5.3, Llama-3.3-70B), so true total spend is somewhat higher —
